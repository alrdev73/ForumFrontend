...
export default function SubforumListItem({id, name, description, replies, threads} : SubforumListItemProp) {
    return (
        <div className={"py-2 relative items-center odd:bg-neutral-300 even:bg-platinum last:shadow-md last:rounded-b-lg flex"}>
            <div className={"px-2 flex items-center"}>
                ...
                <div className={"px-2 flex-none"}>
                    <Link className={"hover:underline hover:text-moonstone"} to={"viewforum/" + id}>{name}</Link>
